from fr_cli.conf.paths import RAG_DB_DIR
"""
...
# ---------- 独立守护进程管理器(已拆到 rag_watcher.py) ----------

# 向后兼容 re-export:老代码可能直接 import RAGWatcherManager
try:
    from fr_cli.agent.builtins.rag_watcher import RAGWatcherManager  # noqa: F401
except Exception:
    pass
